...
/**
 * 04/21/2022 - My first try to run an nRF24 from an ATTiny84.
 * 
 */
...
void setup() {
  ...
  if (!radio.begin()) {
    while (1) {
        //NEW on 4/21/2022: Signal that we're in this infinite loop.
  ...
  //NEW on 4/21/2022: 'radio.begin' successful, show this with steady LED on.
  digitalWrite(ledPin, HIGH);
...
void loop() {
  ...
  if (role) {
    // This device is a TX node
     ...
     //NEW on 4/21/2022: LED on if TX.
    digitalWrite(ledPin, HIGH); // turn the LED on
     //NEW on 4/21/2022: LED off / on to show I'm at this point.
    ...
    // This device is a RX node
     ...
     //NEW on 4/21/2022: LED off if RX.
    digitalWrite(ledPin, LOW); // turn the LED off
