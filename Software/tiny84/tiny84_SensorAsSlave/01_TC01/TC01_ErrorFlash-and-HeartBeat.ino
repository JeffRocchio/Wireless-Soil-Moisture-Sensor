...
// TEST TEST - This sketch is the test case for the HeartBeat and ErrorFlash classes.

// Dispatcher simply initiates a new error# about every 15 seconds. HeartBeat should
// be running continuously in the background, even when the error LED is flashing out
// an error number. This tests to be sure both of those are working as expected,
// including that each of them run independently in a non-blocking manner.


#define VERSION "TC01_070823"
